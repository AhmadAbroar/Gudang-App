                        ...
                        <div class="table-responsive">
                            <form action="{{ route('types.store') }}" method="POST">
                                ...
                                <div class="form-group mt-2">
                                    ...
                                    <input type="text" name="nama_type" class="form-control @error('nama_type') is-invalid @enderror" value="{{ old('nama_type') }}" required>
                                    @error('nama_type')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="form-group mt-2">
                                    ...
                                    <input type="number" name="tahun_rilis" class="form-control @error('tahun_rilis') is-invalid @enderror" value="{{ old('tahun_rilis') }}" required>
                                    @error('tahun_rilis')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
